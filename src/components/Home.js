		...
		return (
			<div className="contents">
				...
				<div className="yellow-text text content">
					<p>
						We know that eating organic means high standards of animal welfare, fewer pesticides, no
						artificial additives, preservatives or routine use of antibiotics. We're inviting people to add
						happiness to the world and their lives by feeding their happy with organic - and to experience
						the unadulterated joy of organic food.
					</p>
				</div>
